import fs from 'fs';
export let pepino = []; //Uma variável global que armazena a lista de todos os contatos como um array de objetos.
export const DBMASTER = "arrayz.json";

export function Pepino(novosContatos) {
    pepino = novosContatos;
}
